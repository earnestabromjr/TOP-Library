...
function validateInput(input) {
	...
	if (input.validity.valueMissing) {
		...
		span.textContent = "The value does not match the required pattern.";
	} else if (input.validity.tooShort) {
		span.textContent = `The value is too short. Minimum length is ${input.minLength}.`;
	} else if (input.validity.tooLong) {
		span.textContent = `The value is too long. Maximum length is ${input.maxLength}.`;
	} else if (input.validity.rangeUnderflow) {
		span.textContent = `The value is too low. Minimum value is ${input.min}.`;
	} else if (input.validity.rangeOverflow) {
		span.textContent = `The value is too high. Maximum value is ${input.max}.`;
	} else if (input.validity.stepMismatch) {
		span.textContent = "The value is not in the correct step.";
	}
